...
function onSubmission() {
  ...
  // i dont think you should call this before declaring display
  //I wasn't I was just checking smth but thank you :)
  // alert(display);
...
function showEligible(text) {
  ...
  //document.getElementById('map_of_foodbanks').style.display = "block";
}